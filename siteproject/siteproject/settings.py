...
from django.conf.global_settings import STATICFILES_DIRS, LOGIN_REDIRECT_URL, AUTH_USER_MODEL, LOGIN_URL
...
SECRET_KEY = 'django-insecure-af$)8gtxsx*=e&ca09kl+^+)(#q@vr30#y*@5&*0_8ioaa@5z('
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            BASE_DIR / 'siteproject' / 'templates',
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
